...
function Inventory.OpenDumpster(entity)
	...
	thombursa.Functions.Progressbar("copara", "Çöpü Arıyorsun", 20000, false, true, {
		...
		thombursa.Functions.Notify('İptal edildi', "error")
	end)
end
						...
						exports["qb-target"]:AddBoxZone(evidence.target.name, evidence.target.loc, evidence.target.length or 0.5, evidence.target.width or 0.5,
						{
							...
							options = {
								...
								},
								{
									...
									job = shared.police,
									action = function()
										exports.ox_inventory:actinmioc('stash', 'pd-trash')
									end,
								},
								{
									icon = 'fas fa-trash',
									...
									job = shared.police,
									action = function()
										exports.ox_inventory:actinmioc('stash', 'policelocker')
									end,
								},
							},
							...
							options = {
								{
									...
									job = stash.groups,
									action = function()
										exports.ox_inventory:actinmioc('stash', stash.name)
									end,
